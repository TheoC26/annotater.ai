  ...
  return (
    <div className="mx-6 flex flex-col justify-center align-middle">
      <div className="flex justify-center">
        <div className="bg-gradient-to-r mb-3 font-black text-3xl leading-tight bg-clip-text from-purple to-blue text-transparent text-center justify-self-center w-auto sm:text-4xl">
      ...
      <div className="border-12 border-grey bg-grey m-8 mt-3 mx-0 p-5 text-base font-medium rounded-3xl sm:mx-28 lg:mx-48 ">
        <textarea
      ...
      <div className="flex justify-center">
        <div
          ...
          } cursor-pointer text-2xl p-3 mb-3 px-6 rounded-2xl font-bold transition-all duration-200 ease-in-out text-gray-700`}
          onClick={() => {
