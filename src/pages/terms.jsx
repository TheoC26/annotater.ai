...
const terms = () => {
  return (
    <>
      <Head>
        <title>annotater.app | terms and conditions</title>
        <meta
          name="description"
      ...
      <div className=" m-32">
        ...
        <b>User Content</b>
        The Annotater and Summarizer may allow you to upload or provide content
        to the service. You retain all rights to any such content and are solely
        responsible for it. By uploading or providing content, you grant
        Annotater.app a non-exclusive, worldwide, royalty-free, perpetual
        license to use, copy, modify, and distribute such content in connection
        with the Annotater and Summarizer. <br /> <br />
        ...
        fitness for a particular purpose, and non-infringement. Annotater.app
        ...
        Annotater.app, its officers, directors, employees, agents, and
        ...
        Annotater and Summarizer. In no event shall Annotater.app be liable for
        ...
        to your use of the Annotater and Summarizer, even if Annotater.app has
        ...
        and Annotater.app with respect to the use of the Annotater and
        Summarizer, and supersedes all prior or contemporaneous communications,
        negotiations, and agreements between you and Annotater.app. By accessing
        or using the Annotater and Sumizer, you acknowledge that you have read,
        understood, and agree to be bound by these terms and conditions. If you
        do not agree to these terms and conditions, you should not use the
        ...
        terms and conditions, please contact Annotater.app at
        annotater.app@gmail.com. <br /> <br />
        Last updated Feburary 16, 2023.
      </div>
    </>
  );
};
